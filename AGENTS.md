...
- Supports touch-specific MathLive, system, and no-auto-open keyboard behavior, independent manual keyboard icons, and a keyboard-toolbar collapse action.
...
- `src/keyboard-collapse-manager.ts`: virtual-keyboard toolbar collapse-action injection, bounded retries, observation, and disposal.
